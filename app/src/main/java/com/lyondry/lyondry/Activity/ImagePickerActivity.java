...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setToolbarColor(ContextCompat.getColor(this, R.color.cyan_light));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.cyan_light));
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.cyan_light));
